...
const app = express();
app.use(bodyParser.json()); // <-- REQUIRED for JSON POST requests
...
bcrypt.hash("test123", 10)
  .then(hash => console.log("Test hash success:", hash))
  .catch(err => console.log("Test hash failed:", err));

app.post("/register", (req, res) => {

    const {name, aadhar, dob, state, city, phoneno, email, password} = req.body;
